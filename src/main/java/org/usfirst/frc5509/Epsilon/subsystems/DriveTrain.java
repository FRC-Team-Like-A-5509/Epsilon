...
public class DriveTrain extends Subsystem {
    ...
    public DriveTrain() {
        ...
        armPivotDrive = new Spark(4);
        addChild("armPivotDrive",armPivotDrive);
        armPivotDrive.setInverted(false);
	...
	public void pivotArms(double speed){
		armPivotDrive.setSpeed(speed);
	}
