...
public class DriveTrain extends Subsystem {
	...
	private final static double inputEndLimit = 512;
	private final static double inputBeginLimit =-512;
	...
	PIDController frontLeftSwerveController;
	PIDController frontRightSwerveController;
	PIDController backLeftSwerveController;
	PIDController backRightSwerveController;
	...
	// END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
		...
		frontLeftSwerveController = new PIDController(PIDP, PIDI, PIDD, new SwervePIDSource(frontLeftSwerve), 
										new SwervePIDOutput(frontLeftSwerve));
		frontLeftSwerveController.setOutputRange(-1.0, 1.0);
		frontLeftSwerveController.setInputRange(inputBeginLimit, inputEndLimit);
		frontLeftSwerveController.setContinuous(true);
		
	
		frontRightSwerveController = new PIDController(PIDP, PIDI, PIDD, new SwervePIDSource(frontRightSwerve), 
										new SwervePIDOutput(frontRightSwerve));
		frontRightSwerveController.setOutputRange(-1.0, 1.0);
		frontRightSwerveController.setInputRange(inputBeginLimit, inputEndLimit);
		frontRightSwerveController.setContinuous(true);
		

		backLeftSwerveController = new PIDController(PIDP, PIDI, PIDD, new SwervePIDSource(backLeftSwerve), 
										new SwervePIDOutput(backLeftSwerve));
		backLeftSwerveController.setOutputRange(-1.0, 1.0);
		backLeftSwerveController.setInputRange(inputBeginLimit, inputEndLimit);
		backLeftSwerveController.setContinuous(true);
		

		backRightSwerveController = new PIDController(PIDP, PIDI, PIDD, new SwervePIDSource(backRightSwerve), 
										new SwervePIDOutput(backRightSwerve));
		backRightSwerveController.setOutputRange(-1.0, 1.0);
		backRightSwerveController.setInputRange(inputBeginLimit, inputEndLimit);
		backRightSwerveController.setContinuous(true);
	...
	public void drive(double rotation, double x, double y) {
		...
		frontRightSwerveController.setEnabled(true);
		frontRightSwerveController.setSetpoint(ticks[0]);
		SmartDashboard.putNumber("frontRightSwervePID", frontRightSwerveController.getSetpoint());
		SmartDashboard.putNumber("frontRightSwerveError", frontRightSwerveController.getError());
		//SmartDashboard.putNumber("frontLeftSwerveSet", ticks[1]);
		frontLeftSwerveController.setEnabled(true);
		frontLeftSwerveController.setSetpoint(ticks[1]);
		SmartDashboard.putNumber("frontLeftSwervePID", frontLeftSwerveController.getSetpoint());
		SmartDashboard.putNumber("frontLeftSwerveError", frontLeftSwerveController.getError());
		//SmartDashboard.putNumber("backLeftSwerveSet", ticks[2]);
		backLeftSwerveController.setEnabled(true);
		backLeftSwerveController.setSetpoint(ticks[2]);
		SmartDashboard.putNumber("backLeftSwervePID", backLeftSwerveController.getSetpoint());
		SmartDashboard.putNumber("backLeftSwerveError", backLeftSwerveController.getError());
		//SmartDashboard.putNumber("backRightSwerveSet", ticks[3]);
		backRightSwerveController.setEnabled(true);
		backRightSwerveController.setSetpoint(ticks[3]);
		SmartDashboard.putNumber("backRightSwervePID", backRightSwerveController.getSetpoint());
		SmartDashboard.putNumber("backRightSwerveError", backRightSwerveController.getError());
